...
The program will run after you save it in the same desetination as the chromedriver and you will need to wait 20 seconds if the "No 'Show more images' button found" is displayed, to see if any further images are being downloaded. It should be safe to use as it uses some techniques like random delays etc., but again use at your own risk.
